...
var hostkey = 'http://smotret24.ru'.replace('http://', '').replace('https://', '');
...
window.rch_nws[hostkey].Registry = function RchRegistry(client, startConnection) {
  window.rch_nws[hostkey].typeInvoke('http://smotret24.ru', function() {
    ...
    client.on("RchClient", function(rchId, url, data, headers, returnHeaders) {
	  ...
	  function sendResult(uri, html) {
	    $.ajax({
	      url: 'http://smotret24.ru/rch/' + uri + '?id=' + rchId,
	      type: 'POST',
	      data: html,
	      async: true,
	      cache: false,
  ...
  function rchRun(json, call) {
    if (typeof NativeWsClient == 'undefined') {
      Lampa.Utils.putScript(["http://smotret24.ru/js/nws-client-es5.js?v18112025"], function() {}, false, function() {
        rchInvoke(json, call);
      }, true);
    } else {
      rchInvoke(json, call);
    ...
    return url;
      ...
      var intervalId = setInterval(function() {
        ...
        function showModal() {
            ...
            var modalHtml = '<div>' +
                                '<img id="qrCodeImage"/>' +
                                '<p>С 25 ноября для просмотра через Smotret! требуется авторизация, пожалуйста отсканируйте QR или введите код в телеграм-боте @showybot или по ссылке t.me/showybot</p>' +
  ...
  function component(object) {
    ...
    if (balansers_with_search == undefined) {
      ...
      network.silent(account('http://smotret24.ru/lite/withsearch'), function(json) {
  ...
  var botElement = $('<div class="myBot" style="line-height: 0.5;color: #ffffff;font-family: &quot;SegoeUI&quot;, sans-serif;font-size: 1em;box-sizing: border-box;outline: none;user-select: none;display: flex;-webkit-box-align: start;align-items: flex-start;position: relative;background-color: rgba(255, 255, 255, 0.1);border-radius: 0.3em;margin: 1.5em 2em;">' +
              ...
              'Тормозит? Хочешь смотреть в 4к? Сканируй QR и бесплатно попробуй нашу PRO версию!' +
              '</div><div class="ad-server__label">' +
              '@Smotr24bot' +
              '</div><img src="http://api.qrserver.com/v1/create-qr-code/?size=200x200&data=http://t.me/Smotr24bot?start=1" class="ad-server__qr"></div>')
